...
/**
 * SkinTemplate class for NewiWiki skin
 * @ingroup Skins
 */
class SkinNewiWiki extends SkinTemplate {
	public $skinname = 'newiwiki';
	public $stylename = 'NewiWiki';
	public $template = 'NewiWikiTemplate';
	/**
	 * @var Config
	 */
	private $newiwikiConfig;

	public function __construct() {
		$this->newiwikiConfig = ConfigFactory::getDefaultInstance()->makeConfig( 'newiwiki' );
	}
	...
	public function initPage( OutputPage $out ) {
		...
		$out->addModules( array( 'skins.newiwiki.js' ) );
	...
	public function setupTemplate( $classname, $repository = false, $cache_dir = false ) {
		return new $classname( $this->newiwikiConfig );
	}
