...
class VoteHooks {
	...
	/**
	 * auto-insert vote tag
	 */
	public static function articleHeader( &$article, &$outputDone, &$pcache ) {
		global $wgOut, $wgVoteAutoInsert, $wgAutoInsertType;
