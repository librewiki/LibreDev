...
var VoteNY = {
	...
	clickVote: function( TheVote, PageID ) {
		...
		sajax_do_call( 'wfVoteClick', [ TheVote, PageID ], function( request ) {
			...
			document.getElementById( 'PollVotes' ).className = "vote-unvote-link";
		} );
	},
	...
	unVote: function( PageID ) {
		...
		sajax_do_call( 'wfVoteDelete', [ PageID ], function( request ) {
			...
			document.getElementById( 'PollVotes' ).innerHTML = result;
			document.getElementById( 'PollVotes' ).className = "vote-vote-link";
		} );
	},
...
jQuery( document ).ready( function() {
	...
	jQuery( '#PollVotes' ).click( function() {
		if (this.className == "vote-vote-link") {
